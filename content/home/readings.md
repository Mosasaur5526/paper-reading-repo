...
* [【not started】Virtual Adversarial Training: A Regularization Method for Supervised and Semi-Supervised Learning (arXiv 1704, TPAMI 2018)](https://arxiv.org/abs/1704.03976)
...
* [【started on 19/3/2022, unfinished】Exploring Memorization in Adversarial Training (arXiv 2106, ICLR 2022)](https://arxiv.org/abs/2106.01606)
...
* [Distilling the Knowledge in a Neural Network (arXiv 1503, NeurIPS 2014 workshop)](https://arxiv.org/abs/1503.02531)
{{< /spoiler >}}
...
- [Visualizing the Loss Landscape of Neural Nets (arXiv 1712, NeurIPS 2018)](https://arxiv.org/abs/1712.09913)
{{< /spoiler >}}
...
- [Region-aware Adaptive Instance Normalization for Image Harmonization (arXiv 2106, CVPR 2021)](https://arxiv.org/abs/2106.02853)
- [GMLight: Lighting Estimation via Geometric Distribution Approximation (arXiv 2102, AAAI 2021)](https://arxiv.org/abs/2102.10244)
...
{{< spoiler text="Robust Learning and Adversarial Defenses (47)" >}}
...
{{< spoiler text="Virtual Try-on, pose estimation and Graphics Related (13)" >}}
...
- [Generating High-Resolution Fashion Model Images Wearing Custom Outfits (arXiv 1908, ICCV 2019 Workshop on Computer Vision for Fashion, Art and Design)](https://arxiv.org/abs/1908.08847)
...
{{< spoiler text="GAN Prior and GAN Inversion (21)" >}}
...
- [ReStyle: A Residual-Based StyleGAN Encoder via Iterative Refinement (arXiv 2104, ICCV 2021)](https://arxiv.org/abs/2104.02699)
...
- [Improved StyleGAN Embedding: Where are the Good Latents? (arXiv 2012)](https://arxiv.org/abs/2012.09036)
- [Improving the Fairness of Deep Generative Models without Retraining (arXiv 2012)](https://arxiv.org/abs/2012.04842)
- [Encoding in style: a stylegan encoder for image-to-image translation (arXiv 2008, CVPR 2021)](https://arxiv.org/abs/2008.00951)
...
- [Self-Attention Generative Adversarial Networks (arXiv 1805, ICML 2019)](https://arxiv.org/abs/1805.08318)
